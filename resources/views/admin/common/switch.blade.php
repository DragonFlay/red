...
<td id="leftbar" style="display: none; background:url(/images/admin/common/switchbg.jpg) repeat-y #d2d2d0 0px 0">
<a onClick="switchSysBar()" href="javascript:void(0);">
<img src="{{'/images/admin/common/pic24.jpg'}}" width="12" height="72" border="0" alt="隐藏左侧菜单" >
</a>
</td>
<td id="rightbar"style="background:url(/images/admin/common/switchbg.jpg) repeat-y #f2f0f5 0px 0">
<a onClick="switchSysBar()" href="javascript:void(0);">
<img src="{{'/images/admin/common/pic24.jpg'}}" width="12" height="72" border="0" alt="隐藏左侧菜单" >
</a>
</td>
