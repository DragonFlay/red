  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
  		  ...
  		  <td width="100%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="{{'/Admin/useradd'}}" target="mainFrame" onFocus="this.blur()" class="add">订单列表</a></td>
  		</tr>
                 <form method="get" action="{{'/Admin/user/userList'}}">
	         <span>用户：</span>
                 
                 <input type="text" name="keyword" value="{{$keyword or ''}}" placeholder="账号、昵称或手机号" class="text-word">
    ...
    <table width="100%" border="0"  cellspacing="0" cellpadding="0" id="main-tab">
      <tr style='text-align:center'>
        ...
        <th  valign="middle" class="borderright">帐号</th>
         <th  valign="middle" class="borderright">昵称</th>
        <th  valign="middle" class="borderright">等级</th>
        <th  valign="middle" class="borderright">积分</th>
        <th  valign="middle" class="borderright">状态</th>
        <th  valign="middle" class="borderright">邮箱</th>
        <th  valign="middle" class="borderright">手机号码</th>
        <th  valign="middle" class="borderright">注册日期</th>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">{{$value->nickname}}</td>
       
        <td align="center" valign="middle" class="borderright borderbottom">{{$value->lname}}</td>
        <td align="center" valign="middle" class="borderright borderbottom"></td>
          <td align="center" valign="middle" class="borderright borderbottom">
           ...
           <td align="center" valign="middle" class="borderright borderbottom">{{$value->email}}</td>
           <td align="center" valign="middle" class="borderright borderbottom">{{$value->phone}}</td>
        <td align="center" valign="middle" class="borderright borderbottom">{{$value->create_at}}</td>
        <td align="center" valign="middle" class="borderbottom"><a href="/Admin/user/uEdit/{{$value->user_id}}" target="mainFrame" onFocus="this.blur()" class="add">查看编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">地址</a><span class="gray">&nbsp;|&nbsp;</span><a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
    @endforeach
