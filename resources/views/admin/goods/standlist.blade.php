...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：商品管理 -> 规格列表
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='red'>
           {{session("info")}}
         </font></td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
  		  ...
  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="{{'/Admin/goods/standa'}}" target="mainFrame" onFocus="this.blur()" class="add">新增规格</a></td>
  		</tr>
                <form method="get" action="{{'/Admin/goods/standlist'}}">
	         <span>商品：</span>
                 <select name='keyword'>
                     @foreach($cids as $k=>$v)
	         ...
	         <input name="" type="submit" value="查询" class="text-but">
                 <a href="/Admin/goods/standlist"> <input name="" type="button" value="刷新" class="text-but"></a>              
	         </form>
	</table>
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>      
        ...
        <th align="center" valign="middle" class="borderright">规格名称</th>
        <th align="center" valign="middle" class="borderright">所属分类</th>        
        <th align="center" valign="middle" class="borderright">规格项</th>    
          
        <th align="center" valign="middle">操作</th>
      </tr>
    @foreach($stands as $key => $stand)
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="center" valign="middle" class="borderright borderbottom">{{$stand->sid}}</td>
         <td align="center" valign="middle" class="borderright borderbottom">{{$stand->title}}</td>
         <td align="center" valign="middle" class="borderright borderbottom">{{$stand->cname}}</td>
         <td align="center" valign="middle" class="borderright borderbottom">{{$stand->extra}}</td>   
         
        <td align="center" valign="middle" class="borderbottom">
     
       <a href="/Admin/goods/stande/{{$stand->sid}}"  target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
