...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置： 商品管理 -> 规格编辑 
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
                    <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><font style="font-size:16px">规格编辑</font></td>
  ...
  <tr>
    <td align="left" valign="top">
  <form method="post" name="fm" action="{{'/Admin/goods/standedit'}}"  enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td  width='90%' valign="middle" class="borderright borderbottom">
            <input type="text" name="title" value="{{$stand->title}}"/>
        </td>            
      </tr>
       <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td  width='90%'valign="middle" class="borderright borderbottom"> 
            <select name="cid">
                @foreach($cids as $k => $v)
                <option value="{{$v->cid}}" @if($stand->cid==$v->cid) selected @endif>{{$v->cname}}</option>
                @endforeach
            </select>
        </td> 
      </tr>
       ...
       <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td  width='90%'valign="middle" class="borderright borderbottom"> 
            <textarea name="extra" placeholder="用逗号隔开每一项" cols="150">{{$stand->extra}}</textarea>
        </td> 
      </tr>
        ...
        <td   class="borderright borderbottom">    
            ...
            <input type="hidden" name="sid" value="{{$stand->sid}}" />
