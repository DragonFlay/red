...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：订单管理 -> 发货单列表
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='red'>
           {{session("info")}}
         </font></td>
  </tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">所选物流</th>
        <th align="center" valign="middle" class="borderright">物流费用</th>
...
@foreach($delivers as $key => $deliver)
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">{{$deliver->username}}</td>       
        ...
        <td align="center" valign="middle" class="borderright borderbottom">{{$deliver->pay_time}}</td>       
        <td align="center" valign="middle" class="borderright borderbottom">{{$deliver->all_money}}</td>       
       <td align="center" valign="middle" class="borderright borderbottom">{{$deliver->add_time}}</td>        
        <td align="center" valign="middle" class="borderbottom">
       <a href="/Admin/order/delivere/{{$deliver->order_id}}"  target="mainFrame" onFocus="this.blur()" class="add">去发货</a>
