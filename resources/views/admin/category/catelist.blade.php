...
#main-tab td{ font-size:12px; height:40px;}//line-height:40px;
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：权限管理 -> 商品分类
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='red'>
           {{session("info")}}
         </font></td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
  		  ...
  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="{{'/Admin/category/catea'}}" target="mainFrame" onFocus="this.blur()" class="add">新增分类</a></td>
  		</tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">商品分类树</th>
        <th align="center" valign="middle" class="borderright">路径</th>
           <th align="center" valign="middle" class="borderright">是否导航</th>
        <th align="center" valign="middle">操作</th>
      </tr>
      @foreach($categories as $key=>$cate)
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="center" valign="middle" class="borderright borderbottom">{{$cate->cid}}</td>
        <td align="left" valign="middle" style="line-height: " class="borderright borderbottom">
            {!!$cate->cname!!}
        ...
        <td align="center" valign="middle" class="borderbottom">
             <a href="/Admin/category/catea/{{$cate->cid}}"  target="mainFrame" onFocus="this.blur()" class="add">添加子类</a> <span class="gray">&nbsp;|&nbsp;</span>
       <a href="/Admin/category/catee/{{$cate->cid}}"  target="mainFrame" onFocus="this.blur()" class="add">编辑</a>
       @if($del[$key]==1)
       
        <span class="gray">&nbsp;|&nbsp;</span>
        <a href="/Admin/category/catedel/{{$cate->cid}}" target="mainFrame" onFocus="this.blur()"  class="del">删除</a></td>
