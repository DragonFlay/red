...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
        ...
        <form method='post'action="{{'/Admin/category/cateadd'}}" >
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td  width='90%' valign="middle" class="borderright borderbottom">
             <input size="50"type='text' name='cname' value=""/>        
        </td>    
      </tr>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td  width='90%'valign="middle" class="borderright borderbottom">
             &nbsp; &nbsp;<input type="radio" id="xx" name="isNav" value='Y' /><label for='xx'>是</label>
             &nbsp;
             &nbsp; <input type="radio" id="yy" name="isNav"value='N' checked="" /><label for='yy'>否</label>
