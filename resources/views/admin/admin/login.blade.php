    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
	    ...
	    <div class="margin text-center">
	        <div class="copyright">
	            2016-2050&copy; <a href="http://red.com">LARAVEL5.1</a>
	            <br/>
	            <a href="http://www.red.com">火箭小组</a>出品
	        </div>
	    </div>
    </div><!-- /.login-box -->
    <!-- jQuery 2.1.4 -->
    <script src="{{asset("/plugins/jQuery-2.1.4.min.js")}}" type="text/javascript"></script>
    <!-- Bootstrap 3.3.2 JS -->
