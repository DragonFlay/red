...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
         ...
         <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"> <a href="{{'/Admin/auth/aAdd'}}" target="mainFrame" onFocus="this.blur()" class="add">
                         新增管理员</a></td>
  		</tr>
                <form method="get" action="{{'/Admin/auth/adminList'}}">
	         <span>管理员：</span>
