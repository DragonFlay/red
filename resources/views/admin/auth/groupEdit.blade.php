...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置： 权限管理 ->分组列表 -> 分组规则
        &nbsp;&nbsp;<font color="red">
            @if(count($errors)>0)
            {{$errors->first()}}
            @endif
  ...
  <tr>
    <td align="left" valign="top">
        <form method="post" action="/Admin/auth/groupEdit/{{$group->gid}}">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td  width='95%' valign="middle" class="borderright borderbottom">
              <input size="50"type='text' name ="title" value="{{$group->title}}"/>
