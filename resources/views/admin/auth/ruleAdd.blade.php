...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
  		  ...
  		  <td width="100%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="{{$_SERVER['HTTP_REFERER']}}" target="mainFrame" onFocus="this.blur()" class="add">返回上一页</a>
                     </td>
  		</tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
        ...
        <form method='post'action="{{'/Admin/auth/ruleAdd'}}" >
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td  width='95%'valign="middle" class="borderright borderbottom">
             &nbsp; &nbsp;<input type="radio" id="xx" name="status" value='1' /><label for='xx'>启用</label>
             &nbsp;
             &nbsp; <input type="radio" id="yy" name="status"value='0' checked="" /><label for='yy'>禁用</label>
        ...
        <td   valign="middle" class="borderright borderbottom">
           <input type="hidden" name="_token" value="{{csrf_token()}}" />
            <input type="submit" style="width:100px" value=" 保存 "/>
            <font color='red'>
            @if(count($errors) >0)
              {{ $errors->first()}}
            @endif
